...
from ..utils.progress import confirm, print_error, print_warning
...
def update_command(
    ...
    try:
        ...
        if not scripts_only and not claude_only:
            if has_copilot or prompts_only:
                console.print(
                    "  [bold blue]� Updating GitHub Copilot prompts...[/bold blue]",
                    end=" "
                )
        ...
        if not scripts_only and not prompts_only:
            if has_claude or claude_only:
                console.print(
                    "  [bold blue]🤖 Updating Claude Code commands...[/bold blue]",
                    end=" "
                )
